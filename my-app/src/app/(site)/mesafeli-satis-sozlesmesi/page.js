    ...
    <div className={styles.aboutPage}>
      ...
      <section className={styles.heroSection}>
        <div className={styles.heroContainer}>
          <h1 className={styles.heroTitle}>Mesafeli Satış Sözleşmesi</h1>
        </div>
      </section>
      ...
      <section className={styles.contentSection}>
        <div className={styles.contentContainer}>
          ...
          <div className={styles.storyBlock}>
            ...
            <p>
              <strong>1.1. Satıcı (Hizmeti Sunan)</strong><br />
            ...
            <p>
              <strong>1.2. Alıcı (Kullanıcı)</strong><br />
              <strong>Ad / Soyad / Ünvan:</strong> [Ad Soyad / Ünvan]<br />
              <strong>Adres:</strong> [Adres]<br />
              <strong>Telefon:</strong> [Telefon Numarası]<br />
            ...
            <h2>Madde 4: Hizmetin Sunulma Şekli ve Destek</h2>
            <p>
            ...
            <h2>Madde 5: Taraflar'ın Hak ve Yükümlülükleri</h2>
            <p>
              <strong>5.1. Alıcı'nın Yükümlülükleri:</strong><br />
              • Platformu hukuka ve işbu Sözleşme'ye uygun kullanmak,<br />
              • Sisteme girdiği araç plakaları ve takip tarihlerinin doğruluğundan bizzat sorumlu olmak,<br />
              • Kullanıcı adı ve şifre bilgilerini gizli tutmak,<br />
              • Satın almak istediği hatırlatıcı hakkı paketinin ödemesini ilgili ödeme adımları üzerinden tamamlamak.
            </p>

            <h2>Madde 6: Bedel, Ödeme ve Sözleşmenin Kurulması</h2>
            <p>
            ...
            <h2>Madde 7: Cayma Hakkı ve Dijital Hizmet</h2>
            <p>
            ...
            <h2>Madde 8: Teknik Kesintiler</h2>
            <p>
            ...
            <h2>Madde 10: Fikri Mülkiyet Hakları</h2>
            <p>
            ...
            <h2>Madde 11: Sorumluluk Sınırı</h2>
            <p>
            ...
            <h2>Madde 12: Uygulanacak Hukuk ve Uyuşmazlıkların Çözümü</h2>
            <p>
